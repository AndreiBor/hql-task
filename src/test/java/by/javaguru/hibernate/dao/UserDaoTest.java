...
import by.javaguru.hibernate.utils.TestDataImporter;
...
class UserDaoTest {
    ...
    void findAveragePaymentAmountByFirstAndLastNames() {
        ...
        Double averagePaymentAmount = userDao
                .findAveragePaymentAmountByFirstAndLastNames(session,
                        PaymentFilter.builder().firstname("Bill").lastname("Gates").build());
